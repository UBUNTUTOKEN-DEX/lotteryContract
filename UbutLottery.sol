...
// File: contracts/interfaces/IUbutSwapLottery.sol

pragma solidity ^0.8.4;

interface IUbutSwapLottery {
    /**
...
// File: contracts/UbutSwapLottery.sol

pragma solidity ^0.8.4;
pragma abicoder v2;

/** @title UbutSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract UbutSwapLottery is ReentrancyGuard, IUbutSwapLottery, Ownable {
     ...
     * @param _ubutTokenAddress: address of the UBUT token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _ubutTokenAddress, address _randomGeneratorAddress) {
        cakeToken = IERC20(_ubutTokenAddress);
